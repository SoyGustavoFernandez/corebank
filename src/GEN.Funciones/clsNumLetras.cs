...
namespace GEN.Funciones
{
    public class clsNumLetras
    {
        ...
        public clsNumLetras(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return clsNumLetras.ToCardinal(Numero, CultureInfo.CurrentCulture);
        }
