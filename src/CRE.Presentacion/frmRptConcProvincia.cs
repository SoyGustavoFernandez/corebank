...
{
    public partial class frmRptConcProvincia : frmBase
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            decimal nIndMoraTotApor = clsVarApl.dicVarGen["nIndMoraMin"];
            ...
            DataTable dtData = new clsRPTCNCredito().CNrptConcZonaDistrito(dFecha);

            if (dtData.Rows.Count == 0)
            {
                MessageBox.Show("No existen datos para el reporte", "Reporte de Conc C por Zona y Provincia", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            dtslist.Add(new ReportDataSource("dsConZonaDistrito", dtData));

            string reportpath = "rptConcZonaProvincia.rdlc";
