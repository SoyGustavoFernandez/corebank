...
{
    public partial class frmRptRegContacto : frmBase
    {

        #region Variables Globales
        string cTituloMsje = "Reporte Registro de Contacto del Cliente";
        ...
        private void ImprimirReporte()
        {
            ...
            DataTable dsReporte = objCE.CNReporteRegistroContacto(Convert.ToDateTime(dtpDesde.Value), Convert.ToDateTime(dtpHasta.Value));
            ...
            dtslist.Add(new ReportDataSource("dsReporteContacto", dsReporte));

            string reportpath = "rptContactoClienteOferta.rdlc";
