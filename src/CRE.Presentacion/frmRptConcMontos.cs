...
{
    public partial class frmRptConcMontos : frmBase
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = new clsRPTCNCredito().CNrptConcMonto(dFecha);


            if (dtData.Rows.Count == 0)
            {
                MessageBox.Show("No existen datos para el reporte", "Reporte de concentración de cartera por montos desembolsados.", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            string reportpath = "rptConcMontoCred.rdlc";
