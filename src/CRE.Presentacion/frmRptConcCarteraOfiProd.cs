...
{
    public partial class frmRptConcCarteraOfiProd : frmBase
    {
        ...
        public frmRptConcCarteraOfiProd()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                ...
                DataTable dtCartera = cnrptcredito.CNrptConcOficiProd(dFecha);
                ...
                if (dtCartera.Rows.Count > 0)
                {
                    ...
                    dtsList.Add(new ReportDataSource("dsConcOfiProd", dtCartera));
                    ...
                    string reportPath = "rptConcOficinaProd.rdlc";
