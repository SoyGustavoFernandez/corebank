...
{
    public partial class frmVisualisarDocRiesgos : frmBase
    {
       public string cRutaNombre, cRutaNombreAnt,cRutaOrigen;
       public string cRuta { get; set; }
       public string nombreArchivo { get; set; }
       public string extencion { get; set; }
        public frmVisualisarDocRiesgos()
        {
            InitializeComponent();
        }
        public frmVisualisarDocRiesgos(string _cRuta, string _nombreArchivo, string _extencion)
        {
            InitializeComponent();
            cRuta = _cRuta;
        ...
        private void frmVisualisarDocRiesgos_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void frmVisualisarDocRiesgos_Load(object sender, EventArgs e)
        {
