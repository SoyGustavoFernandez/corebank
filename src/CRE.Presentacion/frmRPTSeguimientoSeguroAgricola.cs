...
{
    public partial class frmRPTSeguimientoSeguroAgricola : frmBase
    {
        ...
        public frmRPTSeguimientoSeguroAgricola()
        {
            InitializeComponent();
        }

        #region Eventos
        private void frmRPTSeguimientoSeguroAgricola_Load(object sender, EventArgs e)
        {
            cargarComponentes();
            cargarDatos();
        }
        ...
        private void cboAgencia_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable dtUsuarioSeleccionado = objCNCreditoCargaSeguro.CNObtenerListaUsuarioSeguro(idZonaSeleccionado, idAgenciaSeleccionado, dFechaDesde, dFechaHasta, idTipoSeguro: 3);
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtDatosReporte = objCNCreditoCargaSeguro.CNObtenerDatosRPTSeguimientoSeguroAgricola(dFechaDesde, dFechaHasta, idZona, idAgencia, idUsuario);
            DataTable dtResumenReporte = objCNCreditoCargaSeguro.CNObtenerDatosRPTResumenSeguroAgricola(dFechaDesde, dFechaHasta, idZona, idAgencia, idUsuario);
            ...
            dtslist.Add(new ReportDataSource("dsRPTDatosSeguroAgricola", dtDatosReporte));
            dtslist.Add(new ReportDataSource("dsRPTResumenSeguroAgricola", dtResumenReporte));

            string reportpath = "rptReporteSeguimientoSeguroAgricola.rdlc";
        ...
        private void cargarDatos()
        {
            ...
            DataTable dtPersonal = objCNCreditoCargaSeguro.CNObtenerListaUsuarioSeguro(idZona, idAgencia, dFechaDesde, dFechaHasta, idTipoSeguro: 3);
        ...
        {
            clsVarGen objVarGen = clsVarGlobal.lisVars.Find(item => item.cVariable.Contains("cReporteSeguroAgricolaConfiguracionPerfil"));
        ...
        private void habilitarEventHandler(bool lValor)
        {
            if(!lValor)
            {
                ...
                dtpDesde.ValueChanged               -= new EventHandler(dtpDesde_ValueChanged);
                dtpHasta.ValueChanged               -= new EventHandler(dtpHasta_ValueChanged);
            }
            else
            {
                cboZona.SelectedIndexChanged        += new EventHandler(cboZona_SelectedIndexChanged);
