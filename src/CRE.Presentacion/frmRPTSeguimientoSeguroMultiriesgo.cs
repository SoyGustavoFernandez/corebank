...
{
    public partial class frmRPTSeguimientoSeguroMultiriesgo : frmBase
    {
        ...
        public frmRPTSeguimientoSeguroMultiriesgo()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtDatosReporte = objCNCreditoCargaSeguro.CNObtenerDatosRPTSeguimientoSeguroMultiriesgo(dFechaDesde, dFechaHasta, idZona, idAgencia, idUsuario);
            DataTable dtResumenReporte = objCNCreditoCargaSeguro.CNObtenerDatosRPTResumenSeguroMultiriesgo(dFechaDesde, dFechaHasta, idZona, idAgencia, idUsuario);
            ...
            dtslist.Add(new ReportDataSource("dsRPTDatosSeguroMultiriesgo", dtDatosReporte));
            dtslist.Add(new ReportDataSource("dsRPTResumenSeguroMultiriesgo", dtResumenReporte));

            string reportpath = "rptReporteSeguimientoSeguroMultiriesgo.rdlc";
        ...
        private void cargarDatos()
        {
            ...
            DataTable dtPersonal = objCNCreditoCargaSeguro.CNObtenerListaUsuarioSeguro(idZona, idAgencia, dFechaDesde, dFechaHasta, idTipoSeguro: 1);
