...
{
    public partial class frmRptConcCarteraOfiAsesor : frmBase
    {
        ...
        public frmRptConcCarteraOfiAsesor()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                ...
                DataTable dtCartera = cnrptcredito.CNrptConcOficiAsesor(dFecha);
                ...
                if (dtCartera.Rows.Count > 0)
                {
                    ...
                    dtsList.Add(new ReportDataSource("dsConcOfiAsesor", dtCartera));
                    ...
                    string reportPath = "rptConcOficiAsesor.rdlc";
