...
{
    public partial class frmRptConcCarteraMonedaProd : frmBase
    {
        ...
        public frmRptConcCarteraMonedaProd()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                ...
                DataTable dtCartera = cnrptcredito.CNrptConcMonedaProd(dFecha);
                ...
                if (dtCartera.Rows.Count > 0)
                {
                    ...
                    dtsList.Add(new ReportDataSource("dsConcMonProd", dtCartera));
                    ...
                    string reportPath = "rptConcMonedaProdTEP.rdlc";
                    if (rbtGrafico.Checked)
                    {
                        reportPath = "rptConcMonedaProdGraf.rdlc";
                    }
