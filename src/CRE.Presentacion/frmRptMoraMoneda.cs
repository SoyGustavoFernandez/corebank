...
{
    public partial class frmRptMoraMoneda : frmBase
    {
        public frmRptMoraMoneda()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtMora = new clsRPTCNCredito().CNMoraMoneda(pdFecha, pidAgencia);
            if (dtMora.Rows.Count == 0)
            {
                MessageBox.Show("No existen datos para los parametros seleccionados", "Mora Moneda", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            List<ReportDataSource> dtslist = new List<ReportDataSource>();
            dtslist.Clear();
            dtslist.Add(new ReportDataSource("dtsMoraMoneda", dtMora));
            ...
            string reportpath = "RptMoraMoneda.rdlc";
