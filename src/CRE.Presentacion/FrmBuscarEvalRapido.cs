...
{
    public partial class FrmBuscarEvalRapido : frmBase
    {
        public int idCli;
        public int idEvalCred;
        public int idSolicitud;
        public int idOperacion;
        public int idTipEvalCred;
        public int idProducto;
        public decimal nMontoProp;
        public string cNroDocumento;
        public string cNombreCliente;
        private string cTipoEvaluacion = "";
        public string cTipEvalCred = "";

        private clsCNEvaluacion objCapaNegocio;

        public FrmBuscarEvalRapido()
        {
            InitializeComponent();
        }

        public FrmBuscarEvalRapido(string cTipoEvalCre, string cTituloForm = "FrmBuscarEvalRapido")
        {
            InitializeComponent();
            ...
            this.idTipEvalCred = int.Parse(cTipoEvalCre);
        }
        ...
        private void conBusCli_ClicBuscar(object sender, EventArgs e)
        {
            ...
            if (this.idCli != 0)
            {
                ...
                DataTable dt = this.objCapaNegocio.listarSolicitudCreditoCampania(this.idCli, this.idTipEvalCred);
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (dtgEvalCred.CurrentRow != null)
            {
                ...
                this.idTipEvalCred = Convert.ToInt32(dtgEvalCred.CurrentRow.Cells["idTipEvalCred"].Value);
                this.nMontoProp = Convert.ToInt32(dtgEvalCred.CurrentRow.Cells["nCapitalPropuesto"].Value);
                this.cTipEvalCred = dtgEvalCred.CurrentRow.Cells["cTipEvalCred"].Value.ToString();
                this.idProducto = Convert.ToInt32(dtgEvalCred.CurrentRow.Cells["idProducto"].Value);
                this.Close();
            }
        }
