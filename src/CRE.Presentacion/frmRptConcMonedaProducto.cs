...
{
    public partial class frmRptConcMonedaProducto : frmBase
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = new clsRPTCNCredito().CNrptConcMonedaProd(dFecha);
            ...
            dtslist.Add(new ReportDataSource("dsConcMonProd", dtData));

            string reportpath = "rptConcMonedaProdGraf.rdlc";
        ...
        public frmRptConcMonedaProducto()
        {
            InitializeComponent();
        }
