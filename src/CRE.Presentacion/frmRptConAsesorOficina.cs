...
{
    public partial class frmRptConAsesorOficina : frmBase
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            decimal nIndMoraMin = clsVarApl.dicVarGen["nIndMoraMin"];
            ...
            DataTable dtData = new clsRPTCNCredito().CNrptConcAsesorOficina(dFecha);

            if (dtData.Rows.Count == 0)
            {
                MessageBox.Show("No existen datos para el reporte", "Reporte de Conc C Asesor Oficina", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            paramlist.Add(new ReportParameter("nIndMoraMin", nIndMoraMin.ToString(), false));           
            ...
            string reportpath = "rptConcAsesorOficina.rdlc";
