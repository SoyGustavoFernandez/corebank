...
{
    public partial class frmEvalAgrop : frmBase
    {
        #region Variables
        private string cMsjCaption = "Evaluación de Crédito Agropecuario";
        ...
        private void InicializarFormulario()
        {
            ...
            DataSet dsResult = this.objCapaNegocio.InicializarAgro();
        ...
        private void RecuperarDatos(int idEvalCred)
        {
            ...
            decimal nCuotaAnualizadaAprox = this.conCondiCredito.TotalMontoPagarAnualizado();
        ...
        private void TituloForm(string cTipEvalCred, string cMensaje = null)
        {
            if (String.IsNullOrEmpty(cMensaje))
                this.Text = String.Format("Evaluación Agropecuario ({0})", cTipEvalCred);
            else
                this.Text = String.Format("Evaluación Agropecuario ({0}) - {1}", cTipEvalCred, cMensaje);
        }
        ...
        private void ActualizarRcc()
        {
            ...
            decimal nCuotaAprox = this.conCondiCredito.TotalMontoPagarAnualizado();
        ...
        private void btnBusqueda_Click(object sender, EventArgs e)
        {
            ...
            FrmBuscarEv formBuscarEvPyme = new FrmBuscarEv(cIDsTipEvalCredPyme, "Buscar Evaluaciones Agropecuarias");
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            frmNuevaEvPyme nuevaEv = new frmNuevaEvPyme(cIDsTipEvalCredPyme, cIDsSectorEconPyme, 0, "Nueva Evaluación Agropecuaria", false);
        ...
        private void conCondiCredito_CuotaAproximadaChanged(object sender, EventArgs e)
        {
            ...
            this.conEstadosFinancieros.ActualizarPorIndPorMPropPorMAprox(this.listIndiFinanc, this.conCondiCredito.Monto(), this.conCondiCredito.TotalMontoPagarAnualizado());
            ActualizarRcc();
        }
        ...
        private void ActualizarEstadoResultados()
        {
            ...
            foreach (clsEstResEval item in this.listEstResEval)
            {
                if (item.idEEFF == EEFF.VentasNetas)
                {
                    if (nTotalVentas == 0)
                    {
                        item.nTotalMA = nTotalVentasPecuario;
