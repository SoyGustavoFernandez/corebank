...
{
    public partial class frmSIGSaldoProvTraMoraIniSol : frmBase
    {
        ...
        public frmSIGSaldoProvTraMoraIniSol()
        {
            InitializeComponent();
            ...
            switch (nNroRptImprime)
            {
                case 1:
                    ...
                    if (chcBase1.Checked)
                    {
                        ...
                        dtRpt = cnCredito.CNRpt001Histini(dFechaSel, idAgencia);
        ...
        private void cargarOpcionImprime(int nNroRpt)
        {
            ...
            {
                case 1:
                    cRutaReporte = "rptSIGSaldoMoraClienteIni.rdlc";
        ...
        private void frmSIGSaldoProvTraMoraIniSol_FormClosing(object sender, FormClosingEventArgs e)
        {
