...
{
    public partial class frmRptDesAnalista : frmBase
    {
        public frmRptDesAnalista()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtDesem = new clsRPTCNCredito().CNDesembolsoAnalista(pdFecIni, pdFecFin, pidAgencia);
            ...
            dtslist.Clear();
            dtslist.Add(new ReportDataSource("dtsDesembolsoAnalista", dtDesem));
            ...
            string reportpath = "RptDesembolsoAnalista.rdlc";
