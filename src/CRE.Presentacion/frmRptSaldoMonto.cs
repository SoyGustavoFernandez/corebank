...
{
    public partial class frmRptSaldoMonto : frmBase
    {
        public frmRptSaldoMonto()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtSaldo = new clsRPTCNCredito().CNSaldoMontos(pdFecha, pidAgencia);
            if (dtSaldo.Rows.Count == 0)
            {
                MessageBox.Show("No existen datos para los parametros seleccionados", "Saldo Montos", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
