...
{
    public partial class frmRptMoraAnalista : frmBase
    {
        public frmRptMoraAnalista()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtMora = new clsRPTCNCredito().CNMoraAnalista(pdFecha, pidAgencia);
            if (dtMora.Rows.Count==0)
            {
                MessageBox.Show("No existen datos para los parametros seleccionados", "Mora Analista", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            List<ReportDataSource> dtslist = new List<ReportDataSource>();
            dtslist.Clear();
            dtslist.Add(new ReportDataSource("dtsMoraAnalista", dtMora));
            ...
            string reportpath = "RptMoraAnalista.rdlc";
        ...
        private void frmRptMoraProducto_Load(object sender, EventArgs e)
        {
            ...
            cboAgencia1.SelectedValue = clsVarGlobal.User.idAgeCol;
        }
    }
}
