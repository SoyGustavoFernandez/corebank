...
{
    public partial class frmRptConcAsesorOficina : frmBase
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = new clsRPTCNCredito().CNrptConcAsesorOficinaOpe(dFecha, idAgencia);
            ...
            string reportpath = "rptConcAsesorOficina2.rdlc";
        ...
        public frmRptConcAsesorOficina()
        {
            InitializeComponent();
        }
