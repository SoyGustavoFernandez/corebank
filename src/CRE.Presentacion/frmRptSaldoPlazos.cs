...
{
    public partial class frmRptSaldoPlazos : frmBase
    {
        public frmRptSaldoPlazos()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtSaldo = new clsRPTCNCredito().CNSaldoPlazos(pdFecha, pidAgencia);
            if (dtSaldo.Rows.Count == 0)
            {
                MessageBox.Show("No existen datos para los parametros seleccionados", "Saldo Plazos", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            List<ReportDataSource> dtslist = new List<ReportDataSource>();
            dtslist.Clear();
            dtslist.Add(new ReportDataSource("dtsSaldoPlazo", dtSaldo));
            ...
            string reportpath = "RptSaldoPlazo.rdlc";
