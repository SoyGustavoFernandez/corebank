...
{
    public partial class frmEvalResumenConsumo : frmBase
    {
        #region Variables
        private string cMsjCaption = "Evaluación Resumida - Consumo";
        ...
        private int idTipEvalCred = 18;     //RESUMIDA - CONSUMO
        private int idCanal;
        ...
        private void RecuperarDatos(int idEvalCred)
        {
            ...
            {
                MessageBox.Show("Tiene que resolver todas las excepciones de reglas crediticias.", "", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            this.conEstadosFinancierosResumen.AsignarDatos(this.listBalGenEval, this.listEstResEval, this.listIndiFinanc, true, this.objEvalCred.nRemBruta);

            // -- Asignar Condiciones de crédito y propuesta
            this.txtEntFamiliar.Text = this.objEvalCred.cComEntFamiliar;
        ...
        private string EvalCredToXML()
        {
            ...
            dt.Columns.Add("nRemBruta", typeof(decimal));
            ...
            row["nRemBruta"] = this.objEvalCred.nRemBruta;
        ...
        private clsMsjError Validar()
        {
            ...
            if (!this.TipoPeriodoValido())
            {
                objMsjError.AddError("No se permite registrar el periodo como PERIODO FIJO.");
            }
        ...
        private bool TipoPeriodoValido()
        {
            if (Convert.ToInt32(this.cboTipoPeriodo.SelectedValue) == 2)//Periodo Fijo
                return false;
        ...
        {
            if ((this.txtEntFamiliar.Enabled == true) && (String.IsNullOrWhiteSpace(this.txtEntFamiliar.Text)))
                return false;
        ...
        {
            int idEvalCred = 0;
            /******************** Convierte a partir de si_finVaribale->cNoEvaResConsu ***************************/
            cIdProductoNoPasan = clsVarApl.dicVarGen["cNoEvaResConsu"];
            ...
            if (formBuscarEv.idCli != 0)
            {
                ...
                if (formBuscarEv.idSolicitud != 0)
                {
                    ...
                    {
                        //TODO: SolTechnologies - 20.Evita alerta de cambio de formulario
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            if (dt.Rows[0]["idMsje"].ToString().Equals("0"))
                            {
                                ...
                                if (idEvalCred > 0 && existe2.Rows.Count > 0)
                                    new clsCNMotorDecision().MigracionEvalMNB(idEvalCred, "frmEvalResumenConsumo");
                            }
                            else { return; }
                        }
                        else { return; }
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            //TODO: SolTechnologies - 18.Validaciones del Porspecto Nuevo No Bancarizado
            ...
            this.objEvalCred.cComEntFamiliar = this.txtEntFamiliar.Text;
            ...
            //recupera remuneracion bruta
            this.objEvalCred.nRemBruta = this.conEstadosFinancierosResumen.obtenernIngresosBrutos();
            ...
            string xmlDatosAgricola = "<Agricolas/>";
            ...
            //TODO: SolTechnologies - 19.Evaluacion Consumo Resumido
            ...
            if (this.lEsMNB && existe.Rows.Count > 0)
            {
                ...
                if (migra)
                {
                    ...
                    new clsCNMotorDecision().MigracionEvalMNB(idEval, "frmEvalConsumo");
                    this.Close();
                    this.Dispose();
                }
            }
        ...
        private void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            /*** Validacion Score jornalero **/
            if (frmCreJorScoreCliente.esSolicitudJornalero(this.objEvalCred.idSolicitud))
            {
                var oValidarScoreJornalero = new frmCreJorScoreCliente(
                    this.objEvalCred.idCli,
                    this.conCreditoTasa.MontoPropuesto,
                    this.conCreditoTasa.Cuotas(),
                    this.objEvalCred.idSolicitud);
                if (!oValidarScoreJornalero.validar())
                {
                    return;
                }
            }
            ...
            //TODO: SolTechnologies - 17.Se verifica el flujo de aprobacion de la solicitd del MNB
            DataTable existe = new clsCNMotorDecision().ValidaExistenciaMNB(this.objEvalCred.idSolicitud);
            if (existe.Rows.Count > 0)
            {
            ...
            DialogResult dg = MessageBox.Show("¿Seguro que deseas enviar a aprobación de créditos?",
                "Enviar a Aprobación", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        private void ActualizarEstadoResultados()
        {
            ...
            decimal nCuotaDirectosMA = this.objEstadosFinancieros.CDirectosTotalMontoCuotaMA();
            decimal nCuotaDirectosMN = this.objEstadosFinancieros.CDirectosTotalMontoCuotaMN();
            decimal nCuotaDirectosME = this.objEstadosFinancieros.CDirectosTotalMontoCuotaME();
            ...
            {
                if (item.idEEFF == EEFF.CuotaCredDir)
                {
                    item.nTotalMA = nCuotaDirectosMA;
                    item.nTotalMN = nCuotaDirectosMN;
                    item.nTotalME = nCuotaDirectosME;
                }
                else if (item.idEEFF == EEFF.ProvCredIndir)
                {
                    item.nTotalMA = nProvIndirectosMA;
                    item.nTotalMN = nProvIndirectosMN;
                    item.nTotalME = nProvIndirectosME;
                }
        ...
        private void btnExcepciones_Click(object sender, EventArgs e)
        {
            ...
            //TODO: SolTechnologies - 21.Muestra el resultado del score en el btn Excepcion
            int idSolicitud = this.objEvalCred.idSolicitud;
        ...
        private bool ValidarReglasfrmEvalResumenConsumo(bool lMostrarAlerta)
        {
            ...
            cCumpleReglas = new clsCNValidaReglasDinamicas().ValidarReglasCreditos(dtTablaParametros: dtParametros,
                                                                            cNombreFormulario: "frmEvalResumenConsumo",
