...
{
    public partial class frmMantenimientoTipoMod : frmBase
    {
        #region Variables Globales
        private clsCNMantenimientoTablas cnmantenimientotablas = new clsCNMantenimientoTablas();
        private int idMovimiento;
        private string cTituloMensaje = "Mantenimiento Tipos de Modificiación";
        #endregion
        #region Eventos
        public frmMantenimientoTipoMod()
        {
            InitializeComponent();
        }
        private void frmMantenimientoTipoMod_Load(object sender, EventArgs e)
        {
        ...
        {
            DataTable dtMantenimiento = cnmantenimientotablas.ListarTiposModificacion();
        ...
        {
            int idTipoModificacion = idMovimiento;
            ...
            DataTable dtResultado = cnmantenimientotablas.ActualizarTiposModificacion(idTipoModificacion, cDescripcion, idUsuMod, dFechaMod);
