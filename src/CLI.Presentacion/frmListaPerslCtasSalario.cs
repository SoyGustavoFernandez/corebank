...
{
    public partial class frmListaPerslCtasSalario : frmBase
    {
        ...
        public frmListaPerslCtasSalario()
        {
            InitializeComponent();
        }

        private void frmPersonalCtasSalario_Load(object sender, EventArgs e)
        {
            clsCNGuardaPersonal ListaSolAprob = new clsCNGuardaPersonal();
            ListaCtas = ListaSolAprob.ListarCtasPersonal(idCliente);
