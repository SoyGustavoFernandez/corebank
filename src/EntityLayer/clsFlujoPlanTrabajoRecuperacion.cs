...
{
    public class clsFlujoPlanTrabajoRecuperacion
    {
        public int idFlujoPlanTrabajoRecuperacion { get; set; }
        ...
        public clsFlujoPlanTrabajoRecuperacion()
        {
            idFlujoPlanTrabajoRecuperacion       = 0;
