...
{
    public partial class frmRptActivosColab : frmBase
    {
        public frmRptActivosColab()
        {
            InitializeComponent();
        }
