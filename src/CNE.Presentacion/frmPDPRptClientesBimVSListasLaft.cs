...
{
    public partial class frmPDPRptClientesBimVSListasLaft : frmBase
    {
        ...
        public frmPDPRptClientesBimVSListasLaft()
        {
            InitializeComponent();
        ...
        void InicializarComboTipoReporte()
        {
            ...
            dr1["nValue"] = 1;
            dr1["cText"] = "Usr BIM-Lista LAFT";

            DataRow dr2 = dt.NewRow();
            dr2["nValue"] = 2;
            dr2["cText"] = "Usr BIM-Lista OFAC ONU";
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = cnRptPdp.ObtenerReporteClientesBimListasLaft(nModalidad, dFechaDesde.Date, dFechaHasta.Date);

            if (dtData.Rows.Count > 0)
            {
                List<ReportDataSource> dtsList = new List<ReportDataSource>();
                dtsList.Add(new ReportDataSource("dsRptCliBimListLAFT", dtData));
                ...
                string reportPath = "rptReporteClientesBimVSListasLAFT.rdlc";
