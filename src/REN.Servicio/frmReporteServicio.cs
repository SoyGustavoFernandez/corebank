...
namespace CLI.Servicio
{
    public partial class frmReporteServicio : Form
    {
        ...
        public frmReporteServicio(List<ReportDataSource> x_dts, String x_ReportPath)
        {
            dts = x_dts;
        ...
        public frmReporteServicio(List<ReportDataSource> x_dts, String x_ReportPath, List<ReportParameter> x_Parameter)
        {
            dts = x_dts;
            ReportPath = x_ReportPath;
            param = x_Parameter;
        ...
        public frmReporteServicio(List<ReportDataSource> x_dts, String x_ReportPath, List<ReportParameter> x_Parameter, bool x_lIndImpDir)
        {
            dts = x_dts;
            ReportPath = x_ReportPath;
            param = x_Parameter;
        ...
        public frmReporteServicio(List<ReportDataSource> x_dts, String x_ReportPath, List<ReportParameter> x_Parameter, bool x_lIndImpDir, bool lHorizontal_)
        {
            dts = x_dts;
            ReportPath = x_ReportPath;
            param = x_Parameter;
        ...
        public frmReporteServicio(List<ReportDataSource> x_dts, String x_ReportPath, List<ReportParameter> x_Parameter, enuFormatoReporte x_extension)
        {
            dts = x_dts;
            ReportPath = x_ReportPath;
            param = x_Parameter;
        ...
        /// <param name="x_Parameter">coleccion de parametros (ReportParameter)</param>
        /// <param name="x_extension">usar la enumeracion "enuFormatoReporte"</param>
        public frmReporteServicio(List<ReportDataSource> x_dts, String x_ReportPath, List<ReportParameter> x_Parameter, enuFormatoReporte x_extension, string cPath, string cArchivo)
        {
            dts = x_dts;
            ReportPath = x_ReportPath;
            param = x_Parameter;
            ...
            this.frmReporteServicio_Load(null, null);            
        }

        private void frmReporteServicio_Load(object sender, EventArgs e)
        {
            if (lImpDirecta)
