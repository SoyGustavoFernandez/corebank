...
{
    public partial class frmListAprobaSolCTS : frmBase
    {
        ...
        DataTable LisSolApr;
        int Estado = 2;
        public frmListAprobaSolCTS()
        {
            InitializeComponent();
        }
        

        private void frmListAprobaSolCTS_Load(object sender, EventArgs e)
        {
            clsCNSolicCTS ListaSolPend = new clsCNSolicCTS();

            LisSolApr = ListaSolPend.ListSoliciAproba(Estado);
