...
{
    public partial class frmListSolExonAprob : frmBase
    {
        ...
        public frmListSolExonAprob()
        {
            InitializeComponent();
        }

        private void frmListSolExonAprob_Load(object sender, EventArgs e)
        {
            clsCNExoneracionITF ListaSolAprob = new clsCNExoneracionITF();
            ...
            dtgBase1.Columns["cTipoOperacion"].Width = 50;
            dtgBase1.Columns["cTipoOperacion"].HeaderText = "Tipo de Solicitud";
            dtgBase1.Columns["cTipoOperacion"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            dtgBase1.Columns["dFecAprSol"].Visible = false;            
