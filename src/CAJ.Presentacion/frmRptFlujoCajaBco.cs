...
{
    public partial class frmRptFlujoCajaBco : frmBase
    {
        public frmRptFlujoCajaBco()
        {
            InitializeComponent();
        }

        private void frmRptFlujoCajaBco_Load(object sender, EventArgs e)
        {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtRptFlujoCajaBco = new clsCNFlujoCajaBco().CNRptFlujoCajaBco(dFechaInicio, dFechaFinal, idMoneda);
            ...
            if (dtRptFlujoCajaBco.Rows.Count > 0)
            {
                ...
                string reportpath = "rptFlujoCajaBco.rdlc";

                new frmReporteLocal(dtsList, reportpath, paramList).ShowDialog();
            }
            else
            {
                MessageBox.Show("No Existen Datos para el Reporte", "Reporte de Flujo de Caja y Bancos", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        }
    }
