...
{
    public partial class frmRptObservadosSupervision : frmBase
    {
        #region variables
        clsCNVisitaSupervisionOperacion clsVisita = new clsCNVisitaSupervisionOperacion();
        private string cTipoSupervision = "SupervisionOperativa";
        #endregion

        #region Metodos
        public frmRptObservadosSupervision()
        {
            InitializeComponent();
        }
        ...
        /**********************************************************************************************/
        #region Eventos
        private void frmRptObservadosSupervision_Load(object sender, EventArgs e)
        {
        ...
        {
           DataTable dtRptResultado = clsVisita.rptObservadosVisita(
            ...
            if (dtRptResultado.Rows.Count > 0)
            {
                ...
                string reportpath = "rptItemsObservadosSupervisionOperacion.rdlc";
