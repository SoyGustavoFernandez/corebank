...
{
    public partial class frmAsignarCarteraCastigada : frmBase
    {
        ...
        public frmAsignarCarteraCastigada()
        {
            InitializeComponent();
        }       
        ...
        public void cargarDatosOrigen()
        {
            ...
            dtCarteraOrigen = cnCarteraRecupera.ListarCarteraCastigada(conBusUbig1.nIdNodo, Convert.ToInt32(cboAgencia1.SelectedValue));
        ...
        private void btnGrabar1_Click(object sender, EventArgs e)
        {
            if (Validacion())
            {
                DialogResult drResultadoReasignar = MessageBox.Show("Esta seguro de realizar la asignación?", "Asignación de Cartera Castigada", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (drResultadoReasignar == DialogResult.Yes)
                {
                    ...
                    {
                        MessageBox.Show("La Asignacion de Cartera se realizó Correctamente.", "Asignación de Cartera Castigada", MessageBoxButtons.OK, MessageBoxIcon.Information);
