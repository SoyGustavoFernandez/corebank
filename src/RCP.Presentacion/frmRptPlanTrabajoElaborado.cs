...
{
    public partial class frmRptPlanTrabajoElaborado : frmBase
    {
        #region Variables Globales
        private clsCNPlanTrabajo cnPlanTrabajo { get; set; }
        #endregion

        public frmRptPlanTrabajoElaborado()
        {
            InitializeComponent();
        }

        #region Eventos
        private void frmRptPlanTrabajoElaborado_Load(object sender, EventArgs e)
        {
            cargarComponentes();
            cargarDatosDefecto();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtDatosReporte = cnPlanTrabajo.CNObtenerPlanTrabajoElaboradoReporte(nMes, nAnio);
            ...
            dtslist.Add(new ReportDataSource("dsPlanTrabajoElaborado", dtDatosReporte));

            string reportpath = "rptListaPlanTrabajoElaborado.rdlc";
