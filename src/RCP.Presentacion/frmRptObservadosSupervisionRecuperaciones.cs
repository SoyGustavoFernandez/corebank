...
{
    public partial class frmRptObservadosSupervisionRecuperaciones : frmBase
    {
        #region variables
        ...
        #region Metodos
        public frmRptObservadosSupervisionRecuperaciones()
        {
            InitializeComponent();
        }
        ...
        private void frmRptObservadosSupervisionRecuperaciones_Load(object sender, EventArgs e)
        {
