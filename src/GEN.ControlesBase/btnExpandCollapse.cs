...
namespace GEN.ControlesBase
{
    ...
    /// </summary>
    public partial class btnExpandCollapse : UserControl
    {
        ...
        public btnExpandCollapse()
        {
            InitializeComponent();

            #region initialize expanded/collapsed state bitmaps:
            InitButtonStyle(ExpandButtonStyle.Classic);
        ...
        private void InitButtonStyle(ExpandButtonStyle style)
        {
            ...
            switch (_expandButtonStyle)
            {
                case ExpandButtonStyle.Classic:
                    var bmp = Properties.Resources.Collapse;
