...
{
    public partial class frmRegIntervCreSimp : frmBase
    {
        ...
        public bool lDatosDefecto = false;

        public frmRegIntervCreSimp()
        {
            InitializeComponent();
            this.conBusCuentaCli1.cTipoBusqueda = "S";
            this.conBusCuentaCli1.cEstado = "[0,1,13]";
        ...
        private void FrmRegIntervieneCre_Load(object sender, EventArgs e)
        {
            ...
            btnCancelar1.Enabled = (!lDatosDefecto) ? true : false ;

            CargaDatos(idSolicitud);
        }
        ...
        public void CargaDatos(int _idSolicitud)
        {

            int nIdSol = _idSolicitud;

            conBusCuentaCli1.asignarCuenta(nIdSol);
            if (nIdSol == 0)
            {
                LimpiarControles();
                conBusCuentaCli1.txtNroBusqueda.Focus();
