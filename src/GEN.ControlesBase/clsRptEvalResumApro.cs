...
{
    class clsRptEvalResumApro : clsRptEvalInterface
    {
        ...
        public clsRptEvalResumApro(int idEval, int idSol)
        {
        ...
        public clsRptEvalResumApro(int idEval, int idSol, Form frm)
        {
            this.idEvalCre = idEval;
            this.idSolicitud = idSol;
            this.cNombreEval = "RESUMIDA";
        ...
        public void ImpPropuestaEval()
        {
            ...
            if (dsProp.Tables.Count > 0)
            {
                if (this.frmReporteProp == null)
                {
                    ...
                    string reportpath = "rptEvalResumenAprob.rdlc";
        ...
        public void ImpEEFF()
        {
            MessageBox.Show("holaa soy goku y te aprobare un credito", "hl");
        }
