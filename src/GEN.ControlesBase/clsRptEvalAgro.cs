...
{
    public class clsRptEvalAgro : clsRptEvalInterface
    {
        ...
        public clsRptEvalAgro(int idEval, int idSol)
        {
        ...
        public clsRptEvalAgro(int idEval, int idSol, Form frm)
        {
            this.idEvalCre = idEval;
            this.idSolicitud = idSol;
            this.cNombreEval = "AGROPECUARIO";
        ...
        public void ImpHojaTrabajo()
        {
            ...
            if (this.dsHTrab.Tables.Count > 0)
            {
                if (this.frmReporteHTrab == null)
                {
                    ...
                    dtsList.Add(new ReportDataSource("dsVentasCostosNuevo", this.dsHTrab.Tables[6]));
