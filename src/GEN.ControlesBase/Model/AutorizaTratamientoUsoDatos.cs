...
namespace GEN.ControlesBase.Model
{
    ...
    public class AutorizaTratamientoUsoDatos : clsAuditoria
    {
        ...
        {
            get { return cArchivoBinary==null? null : clsAuditoria.String2ByteArray(cArchivoBinary); }
            set {} 
        }
        ...
        public string cVerDocumento { get; set; }
    ...
    public class ListaAutorizaTratamientoUsoDatos : BindingList<AutorizaTratamientoUsoDatos>
    {
