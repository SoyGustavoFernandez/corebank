...
{
    public partial class conActividadCIIU : UserControl
    {
        ...
        private void lblBase5_MouseHover(object sender, EventArgs e)
        {
            ...
            this.ttpMensaje.SetToolTip(this.lblBase5, this.cboActividadEco.Text);
        }
        ...
        private void lblBase6_MouseHover(object sender, EventArgs e)
        {
            ...
            this.ttpMensaje.SetToolTip(this.lblBase6, this.cboGrupoCiiu.Text);
        }
        ...
        private void lblBase3_MouseHover(object sender, EventArgs e)
        {
            ...
            this.ttpMensaje.SetToolTip(this.lblBase3, this.cboCIIU.Text);
        }
