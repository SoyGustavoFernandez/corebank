...
namespace GEN.ControlesBase
{
    ...
    public class clsComboTreeDropDown : ToolStripDropDown
    {
        ...
        private cboMenu _sourceControl;
        ...
        /// </summary>
        public clsComboTreeNode TopNode
        {
            get
            {
        ...
        /// <summary>
        /// Initialises a new instance of clsComboTreeDropDown and associates it with its parent ComboTreeBox.
        /// </summary>
        /// <param name="sourceControl"></param>
        public clsComboTreeDropDown(cboMenu sourceControl)
        {
        ...
        /// <returns></returns>
        private clsComboTreeNodeCollection GetCollectionContainingNode(clsComboTreeNode node)
        {
        ...
        /// <param name="node"></param>
        /// <returns></returns>
        private Image GetItemBitmap(clsComboTreeNode node)
        {
            BitmapInfo bitmapInfo = new BitmapInfo();

            // the following factors determine the bitmap drawn:
            clsComboTreeNodeCollection collection = GetCollectionContainingNode(node);
            ...
            while ((parent = parent.Parent) != null)
            {
                ...
                clsComboTreeNodeCollection parentCollection = GetCollectionContainingNode(parent);
        ...
        public void Open()
        {
            ...
            if (_sourceControl.ShowCheckBoxes)
            {
                foreach (clsComboTreeNode node in _sourceControl.CheckedNodes)
                {
                    ExpandTo(node);
                }
            }
            ...
            clsComboTreeNode scrollToNode = null;
            if (_sourceControl.ShowCheckBoxes)
            {
                foreach (clsComboTreeNode node in _sourceControl.CheckedNodes)
                {
        ...
        /// </summary>
        /// <param name="node"></param>
        private void ExpandTo(clsComboTreeNode node)
        {
        ...
        /// </summary>
        /// <param name="node"></param>
        private void ScrollTo(clsComboTreeNode node)
        {
            for (int i = 0; i < _visibleItems.Count; i++)
            {
        ...
        internal void UpdateVisibleItems()
        {
            ...
            _visibleItems.Clear();
            foreach (clsComboTreeNode node in _sourceControl.AllNodes)
            {
        ...
        private class NodeInfo
        {
            ...
            /// </summary>
            /// <param name="node"></param>
            public NodeInfo(clsComboTreeNode node)
            {
                Node = node;
            }
        }
