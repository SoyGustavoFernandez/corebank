...
namespace GEN.ControlesBase
{
    ...
    public partial class cboMenu : cboTreeBase
    {
        ...
        private clsComboTreeDropDown _dropDown;
        ...
        private clsComboTreeNodeCollection _nodes;
        private string _nullValue;
        private string _pathSeparator;
        private string _checkedNodeSeparator;
        private clsComboTreeNode _selectedNode;
        ...
        /// </summary>
        [Browsable(false)]
        public IEnumerable<clsComboTreeNode> AllNodes
        {
            get
            {
                IEnumerator<clsComboTreeNode> e = clsComboTreeNodeCollection.GetNodesRecursive(_nodes, false);
        ...
        public bool CascadeCheckState
        {
            ...
            set
            {
                ...
                if (diff && _cascadeCheckState)
                {
                    ...
                    IEnumerator<clsComboTreeNode> e = clsComboTreeNodeCollection.GetNodesRecursive(_nodes, true);
                    while (e.MoveNext())
                    {
        ...
        /// </summary>
        [Browsable(false)]
        public IEnumerable<clsComboTreeNode> CheckedNodes
        {
            get
            {
                IEnumerator<clsComboTreeNode> e = clsComboTreeNodeCollection.GetNodesRecursive(_nodes, false);
            ...
            set
            {
                ...
                foreach (clsComboTreeNode node in value)
                {
                    node.Checked = true;
                }
            }
        ...
        public clsComboTreeNodeCollection Nodes
        {
            get { return _nodes; }
        }
        /// <summary>
        ...
        /// </summary>
        [Browsable(false)]
        public clsComboTreeNode SelectedNode
        {
        ...
        public clsComboTreeNode FirstVisibleNode
        {
            get
            {
        ...
        internal bool NodeLinesNeeded
        {
            get
            {
                ...
                foreach (clsComboTreeNode node in Nodes)
                {
        ...
        /// <summary>
        /// Initalises a new instance of cboMenu.
        /// </summary>
        public cboMenu()
        {
            ...
            // nodes collection
            _nodes = new clsComboTreeNodeCollection(null);
            ...
            // dropdown portion
            _dropDown = new clsComboTreeDropDown(this);
        ...
        {
            foreach (clsComboTreeNode node in AllNodes) node.Expanded = false;
        }
        ...
        {
            foreach (clsComboTreeNode node in AllNodes) if (node.Nodes.Count > 0) node.Expanded = true;
        }
        ...
        /// </summary>
        /// <returns></returns>
        private clsComboTreeNode GetNextDisplayedNode()
        {
            bool started = false;
            IEnumerator<clsComboTreeNode> e = clsComboTreeNodeCollection.GetNodesRecursive(_nodes, false);
            while (e.MoveNext())
        ...
        /// </summary>
        /// <returns></returns>
        private clsComboTreeNode GetPrevDisplayedNode()
        {
            bool started = false;
            IEnumerator<clsComboTreeNode> e = clsComboTreeNodeCollection.GetNodesRecursive(_nodes, true);
            while (e.MoveNext())
        ...
        /// <returns></returns>
        internal Image GetNodeImage(clsComboTreeNode node)
        {
        ...
        /// <returns></returns>
        internal static Image GetNodeImage(clsComboTreeNode node, ImageList images, int imageIndex, string imageKey, int expandedImageIndex, string expandedImageKey)
        {
        ...
        /// <param name="node"></param>
        /// <returns></returns>
        internal bool IsNodeVisible(clsComboTreeNode node)
        {
            bool displayed = true;
            clsComboTreeNode parent = node;
        ...
        protected override void OnMouseWheel(MouseEventArgs e)
        {
            ...
            {
                clsComboTreeNode prev = GetPrevDisplayedNode();
                if (prev != null) SetSelectedNode(prev);
            }
            else if (e.Delta < 0)
            {
                clsComboTreeNode next = GetNextDisplayedNode();
        ...
        /// <param name="node"></param>
        /// <returns></returns>
        public string GetFullPath(clsComboTreeNode node)
        {
        ...
        /// <returns></returns>
        public clsComboTreeNode GetNodeAt(string path)
        {
        ...
        private string GetCheckedNodeString()
        {
            ...
            foreach (clsComboTreeNode node in CheckedNodes)
            {
                if (_showPath)
        ...
        /// <summary>
        /// Determines whether the specified node belongs to this cboMenu, and 
        /// hence is a valid selection. For the purposes of this method, a null 
        /// value is always a valid selection.
        /// </summary>
        /// <param name="node"></param>
        /// <returns></returns>
        private bool OwnsNode(clsComboTreeNode node)
        {
        ...
        /// </summary>
        /// <param name="node"></param>
        private void SetSelectedNode(clsComboTreeNode node)
        {
        ...
        public void Sort(IComparer<clsComboTreeNode> comparer)
        {
        ...
        void nodes_AfterCheck(object sender, ComboTreeNodeEventArgs e)
        {
            if (_cascadeCheckState)
            {
                ...
                if (_recurseDepth == 1)
                {
                    foreach (clsComboTreeNode child in e.Node.Nodes)
                    {
                        if (_threeState)
