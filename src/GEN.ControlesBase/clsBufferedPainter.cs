...
namespace GEN.ControlesBase
{
    ...
    public class clsBufferedPainter<TState>
    {
        ...
        /// <summary>
        /// Initialises a new instance of the clsBufferedPainter class.
        /// </summary>
        /// <param name="control">
        ...
        /// </para> 
        /// </param>
        public clsBufferedPainter(Control control)
        {
    ...
    /// <summary>
    /// EventArgs class for the clsBufferedPainter.PaintVisualState event.
    /// </summary>
    /// <typeparam name="TState">Any type representing the visual state of the control.</typeparam>
