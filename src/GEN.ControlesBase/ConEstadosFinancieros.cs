...
{
    public partial class ConEstadosFinancieros : UserControl
    {
        ...
        private bool lCampaniaActiva;

        //private bool lOtrosIngresosHabilitado

        public ConEstadosFinancieros()
        {
            InitializeComponent();
        ...
        public void AsignarDatos(List<clsBalGenEval> _listBalGenEval, List<clsEstResEval> _listEstResEval, List<clsIndicadorEval> _listIndiFinanc, List<clsDetBalGenEval> _listInventario,
            ...
            int _idTipEvalCred, decimal _nTotalPlantel, decimal _nTotalSaca, int _idEvalCred, int idCliente, int idDestino, int idProducto = 0)
        {
            // -- Eventos
            ...
            this.conIndicadores.AsignarDatos(_listIndiFinanc, _listBalGenEval, _listEstResEval, _listInventario,
                ...
                this.idTipEvalCred, this.nTotalPlantel, this.nTotalSaca, this.idEvalCred, idProducto);
        ...
        public void EERRCampaniaEstamosContigo()
        {
            this.lCampaniaActiva = true;
        }
        ...
        private void StyleCellDataGridViewEERR()
        {
            ...
            foreach (DataGridViewRow row in this.dtgEstResEval.Rows)
            {
                ...
                if (this.lCampaniaActiva && (idEEFF == EEFF.IngresoJrnlTitular || idEEFF == EEFF.IngresoJrnlCónyuge || idEEFF == EEFF.GastosFamiliares))
                {
                    row.Cells["nTotalMA"].Style.BackColor = GridViewStyle.GridViewBackColorEditable;
                    row.Cells["nTotalMA"].ReadOnly = false;
                ...
                else if (idEEFF == EEFF.UtilidadBruta || idEEFF == EEFF.UtilidadOperativa ||
        ...
        private void btnEvalHorizontal_Click(object sender, EventArgs e)
        {
            ...
            if (EHZTLClick != null)
                EHZTLClick(sender, e);
            //frmBusHorizontal objBusHorizontal = new frmBusHorizontal(5500);
            //objBusHorizontal.ShowDialog();
        }
