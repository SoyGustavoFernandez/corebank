...
{
    public class clsRptEvalAgri : clsRptEvalInterface
    {
        ...
        public clsRptEvalAgri(int idEval, int idSol)
        {
            this.idEvalCre = idEval;
            this.idSolicitud = idSol;
            this.cNombreEval = "AGRICOLA";
            this.cnEval = new clsCNEvaluacion();
            this.cNomAgen = clsVarGlobal.cNomAge.ToString();
        }

        public clsRptEvalAgri(int idEval, int idSol, Form frm)
        {
            this.idEvalCre = idEval;
            this.idSolicitud = idSol;
            this.cNombreEval = "AGRICOLA";
        ...
        public void ImpEEFF()
        {
            ...
            if (this.frmReporteEEFF == null)
                this.dsEEFF = cnEval.CNEstadosFinanEvalAgrico(this.idSolicitud, this.idEvalCre);
            ...
            if (this.dsEEFF.Tables.Count > 0)
            {
                if (this.frmReporteEEFF == null)
                {
                    ...
                    dtsList.Add(new ReportDataSource("dsDestino", this.dsEEFF.Tables[0]));
                    dtsList.Add(new ReportDataSource("dsSolicitud", this.dsEEFF.Tables[1]));
                    dtsList.Add(new ReportDataSource("dsEvaluacion", this.dsEEFF.Tables[2]));
                    dtsList.Add(new ReportDataSource("dsIndicadores", this.dsEEFF.Tables[3]));
                    dtsList.Add(new ReportDataSource("dsBBGG", this.dsEEFF.Tables[4]));
                    dtsList.Add(new ReportDataSource("dsDeudaDirecta", filtrarDataValorColumna(this.dsEEFF.Tables[5], "idTipoDeuda", 1)));
                    dtsList.Add(new ReportDataSource("dsDeudaIndirecta", filtrarDataValorColumna(this.dsEEFF.Tables[5], "idTipoDeuda", 2)));
                    dtsList.Add(new ReportDataSource("dsIngresos", filtrarDataValorColumna(this.dsEEFF.Tables[6], "nOperacion", 1)));
                    dtsList.Add(new ReportDataSource("dsEgresos", filtrarDataValorColumna(this.dsEEFF.Tables[6], "nOperacion", 2)));
                    dtsList.Add(new ReportDataSource("dsSaldos", this.dsEEFF.Tables[7]));
                    dtsList.Add(new ReportDataSource("dsCultivos", this.dsEEFF.Tables[8]));
                    ...
                    string reportPath = "rptEvalPropEEFFAgrico.rdlc";
        ...
        public void ImpHojaTrabajo()
        {
            ...
            if (this.dsHTrab.Tables.Count > 0)
            {
                if (this.frmReporteHTrab == null)
                {
                    ...
                    dtsList.Add(new ReportDataSource("dsInventarioCodigo", filtrarDataValorColumna(dsHTrab.Tables[5], "idEEFF", EEFF.Inventario)));
                    ...
                    string reportPath = "RptHojaTrabAgro.rdlc";
