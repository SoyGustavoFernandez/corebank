...
namespace GEN.ControlesBase
{
    ...
    public class conLoaderToolStripMenu : ToolStripControlHost
    {
        // Constants =========================================================
        ...
        public conLoader LoadingCircleControl
        {
            get { return Control as conLoader; }
        }

        // Constructor ========================================================
        /// <summary>
        /// Initializes a new instance of the <see cref="conLoaderToolStripMenu"/> class.
        /// </summary>
        public conLoaderToolStripMenu()
            : base(new conLoader())
        {
        }
