...
namespace GEN.ControlesBase
{
    ...
    public class TimePickerCell : DataGridViewTextBoxCell
    {
        ...
        public override Type EditType
        {
            get
            {
                ...
                return typeof(TimePickerEditingControl);
            }
        }
    ...
    class TimePickerEditingControl : TimerPicker, IDataGridViewEditingControl
    {
    ...
    public class TimerPicker : System.Windows.Forms.DateTimePicker
    {
