...
{
    public partial class cboTipoValoradoFiltro : cboBase
    {
        public cboTipoValoradoFiltro()
        {
            InitializeComponent();
        }

        public cboTipoValoradoFiltro(IContainer container)
        {
            container.Add(this);
            ...
            dt.DefaultView.RowFilter = ("idTipoValorado = 3 OR idTipoValorado = 4");
            this.DataSource = dt;
