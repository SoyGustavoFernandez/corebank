...
{
    public partial class ConCondiCreditoRural : UserControl
    {
        ...
        public event EventHandler FlujoCajaClick;
        ...
        public void getIdEvalCred(int idEvalCred)
        {
            ...
            this.conCreditoTasa.getIdEvalCred(this.idEvalCred);
        }

        #region "Properties"
        public bool lMostrarBtnFlujoCaja
        {
            set
            {
                this.btnFlujoCaja.Visible = value;
            }
            get { return this.btnFlujoCaja.Visible; }
        }
        ...
        public bool ButtonFlujoCaja
        {
            get
            {
                return this.btnFlujoCaja.Enabled;
            }
            set
            {
                this.btnFlujoCaja.Enabled = value;
            }
        }

        public int TipoPeriodo()
        {
            return conCreditoTasa.TipoPeriodo();
        }

        public int Periodo()
        {
            return conCreditoTasa.Periodo();
        }
                    ...
                    List<clsBalGenEval> _listBalGenEval, List<clsEstResEval> _listEstResEval)
        {
            ...
            conCreditoPeriodo_ChangeTipoPeriodo(null, null);
            EstablecerCuotaAprox();

            //this.conCreditoTasa.conCreditoPeriodo.cboTipoPeriodo_SelectedIndexChanged(null, null);
            //this.conCreditoTasa.conCreditoPeriodo_ChangeTipoPeriodo(null,null);
        }
        ...
        /// <summary>
        /// Retorna la fecha de desembolso del crédito
        /// </summary>
        /// <returns></returns>
        public DateTime FechaDesembolso()
        {
            return this.conCreditoTasa.FechaDesembolso();
        }

        /// <summary>
        /// Retorna la fecha de la primera Cuota
        /// </summary>
        /// <returns></returns>
        public DateTime FechaPrimeraCuota()
        {
            return this.conCreditoTasa.FechaPrimeraCuota();
        }
        ...
        {
            if (FlujoCajaClick != null)
                FlujoCajaClick(sender, e);
        }

        private void conCreditoPeriodo_ChangeTipoPeriodo(object sender, EventArgs e)
        {
            int idTipoPeriodo = (conCreditoTasa.conCreditoPeriodo.idTipoPeriodo >= 0) ? conCreditoTasa.conCreditoPeriodo.idTipoPeriodo : 0;
            ...
            else if (idTipoPeriodo == (int)eTipoPeriodoCred.PeriodoFijo)
                conCreditoPeriodo_ChangePeriodo(null, null);
            else
                btnFlujoCaja.Enabled = false;
        }
        private void conCreditoPeriodo_ChangePeriodo(object sender, EventArgs e)
        {
            int idPeriodo = (conCreditoTasa.conCreditoPeriodo.idPeriodo >= 0) ? conCreditoTasa.conCreditoPeriodo.idPeriodo : 0;

            btnFlujoCaja.Enabled = (idPeriodo == (int)ePeriodoCred.Mensual ||
               idPeriodo == (int)ePeriodoCred.Unicuota) ? true : false;
        }
