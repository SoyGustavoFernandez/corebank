...
{
    public class clsRptEvalPymeH2000 : clsRptEvalInterface
    {
        ...
        public clsRptEvalPymeH2000(int idEval, int idSol)
        {
        ...
        public clsRptEvalPymeH2000(int idEval, int idSol, Form frm)
        {
            this.idEvalCre = idEval;
            this.idSolicitud = idSol;
            this.cNombreEval = "PYME";
