...
{
    public class clsRptEvalAgroH2000 : clsRptEvalInterface
    {
        ...
        public clsRptEvalAgroH2000(int idEval, int idSol)
        {
            this.idEvalCre = idEval;
            this.idSolicitud = idSol;
            this.cNombreEval = "AGROPECUARIO";
            this.cnEval = new clsCNEvaluacion();
            this.cNomAgen = clsVarGlobal.cNomAge.ToString();
        }

        public clsRptEvalAgroH2000(int idEval, int idSol, Form frm)
        {
            this.idEvalCre = idEval;
            this.idSolicitud = idSol;
            this.cNombreEval = "AGROPECUARIO";
        ...
        public void ImpEEFF()
        {
            ...
            if (this.frmReporteEEFF == null)
                this.dsEEFF = cnEval.CNEstadosFinanEvalH2000(this.idSolicitud, this.idEvalCre);
            ...
            if (this.dsEEFF.Tables.Count > 0)
            {
                if (this.frmReporteEEFF == null)
                {
                    ...
                    dtsList.Add(new ReportDataSource("dsVentasCostos", dsEEFF.Tables[6]));
                    dtsList.Add(new ReportDataSource("dsCosteo", dsEEFF.Tables[7]));
                    dtsList.Add(new ReportDataSource("dsGastosPersonal", filtrarDataValorColumna(this.dsEEFF.Tables[8], "idEEFF", EEFF.GastosPersonales)));
                    dtsList.Add(new ReportDataSource("dsGastosOperativos", filtrarDataValorColumna(this.dsEEFF.Tables[8], "idEEFF", EEFF.GastosOperativos)));
                    dtsList.Add(new ReportDataSource("dsGastosFamiliare", filtrarDataValorColumna(this.dsEEFF.Tables[8], "idEEFF", EEFF.GastosFamiliares)));
                    dtsList.Add(new ReportDataSource("dsOtrosIngresos", filtrarDataValorColumna(this.dsEEFF.Tables[8], "idEEFF", EEFF.OtrosIngresos)));
                    dtsList.Add(new ReportDataSource("dsOtrosEgresos", filtrarDataValorColumna(this.dsEEFF.Tables[8], "idEEFF", EEFF.OtrosEgresos)));
                    dtsList.Add(new ReportDataSource("dsDeudaDirecta", filtrarDataValorColumna(this.dsEEFF.Tables[9], "idTipoDeuda", 1)));
                    dtsList.Add(new ReportDataSource("dsDeudaIndirecta", filtrarDataValorColumna(this.dsEEFF.Tables[9], "idTipoDeuda", 2)));

                    paramList.Add(new ReportParameter("idSolicitud", this.idSolicitud.ToString()));
                    ...
                    string reportPath = "rptEvalPropEEFF2.rdlc";
        ...
        public void ImpFlujoCaja()
        {
            ...
            if (this.frmReporteFCaja == null)
                this.dsFCaja = cnEval.FlujoCajaEvalAgro(this.idEvalCre);
