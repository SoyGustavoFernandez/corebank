...
namespace GEN.ControlesBase
{
    ...
    public class clsComboTreeNode : IComparable<clsComboTreeNode>
    {
        ...
        private clsComboTreeNode _parent;
        private object _tag;
        ...
        /// </summary>
        [Browsable(false)]
        public clsComboTreeNode Parent
        {
            get { return _parent; }
        ...
        /// </summary>
        [DefaultValue("clsComboTreeNode"), Description("The text displayed on the node."), Category("Appearance")]
        public string Text
        {
            get { return _text; }
            set { _text = value; }
        ...
        /// <summary>
        /// Gets or sets a user-defined object associated with this clsComboTreeNode.
        /// </summary>
        [Description("User-defined object associated with this clsComboTreeNode."), DefaultValue(""), Category("Data"), TypeConverter(typeof(StringConverter))]
        public object Tag
        {
            get { return _tag; }
            set { _tag = value; }
        ...
        /// <summary>
        /// Initialises a new instance of clsComboTreeNode using default (empty) values.
        /// </summary>
        public clsComboTreeNode()
        {
            _nodes = new clsComboTreeNodeCollection(this);
        ...
        /// <summary>
        /// Initialises a new instance of clsComboTreeNode with the specified text.
        /// </summary>
        /// <param name="text"></param>
        public clsComboTreeNode(string text)
            : this()
        {
            this._text = text;
        }
        ...
        /// <summary>
        /// Initialises a new instance of clsComboTreeNode with the specified name and text.
        /// </summary>
        /// <param name="name"></param>
        /// <param name="text"></param>
        public clsComboTreeNode(string name, string text)
            : this()
        {
            this._text = text;
            this._name = name;
        ...
        internal CheckState GetAggregateCheckState()
        {
            ...
            foreach (clsComboTreeNode child in Nodes)
            {
        ...
        /// <summary>
        /// Returns a string representation of this <see cref="clsComboTreeNode"/>.
        /// </summary>
        /// <returns></returns>
        ...
        #region IComparable<clsComboTreeNode> Members

        /// <summary>
        /// Compares two clsComboTreeNode objects using a culture-invariant, case-insensitive comparison of the Text property.
        /// </summary>
        /// <param name="other"></param>
        /// <returns></returns>
        public int CompareTo(clsComboTreeNode other)
        {
    ...
    public class ComboTreeNodeEventArgs : EventArgs
    {
        ...
        public ComboTreeNodeEventArgs(clsComboTreeNode node)
        {
            Node = node;
        }
    }
