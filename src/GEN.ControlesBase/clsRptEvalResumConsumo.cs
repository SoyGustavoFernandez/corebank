...
{
    class clsRptEvalResumConsumo : clsRptEvalInterface
    {
        ...
        public clsRptEvalResumConsumo(int idEval, int idSol)
        {
        ...
        public clsRptEvalResumConsumo(int idEval, int idSol, Form frm)
        {
            this.idEvalCre = idEval;
            this.idSolicitud = idSol;
            this.cNombreEval = "AGRICOLA";
        ...
        public void ImpPropuestaEval()
        {
            ...
            if (dsProp.Tables.Count > 0)
            {
                if (this.frmReporteProp == null)
                {
                    ...
                    string reportpath = "rptEvalResumenConsumo.rdlc";
