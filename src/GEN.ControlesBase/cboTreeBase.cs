...
namespace GEN.ControlesBase
{
    ...
    public abstract partial class cboTreeBase : Control
    {
        ...
        private clsBufferedPainter<ComboBoxState> _bufferedPainter;
        ...
        /// <summary>
        /// Creates a new instance of cboTreeBase.
        /// </summary>
        public cboTreeBase()
        {
            // control styles
            ...
            // buffered painting
            _bufferedPainter = new clsBufferedPainter<ComboBoxState>(this);
