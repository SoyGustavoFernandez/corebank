...
{
    public partial class frmBCRAnexo01 : frmBase
    {
        #region Eventos
        public frmBCRAnexo01()
        {
            InitializeComponent();
        }
        ...
        private void btnExporExcel1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtDatos = new clsRPTCNContabilidad().BCRAnexo01(dfechaPro);
            ...
            if (dtDatos.Rows.Count > 0)
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    cNomArc = cNomArc + "BCRAnexo01.xlsx";
                    cNomArcDes = cRuta + "\\" + "BCR_Anexo01_" + pcNombMes + ".xlsx";

                    Excel.Application application = new Excel.Application();
                    Excel.Workbook workbook = application.Workbooks.Open(cNomArc);
                    Excel.Worksheet worksheetDG = workbook.Sheets["AN01"];

                    DateTimeFormatInfo dtinfo = new CultureInfo("es-ES", false).DateTimeFormat;

                    string pcAnio = dfechaPro.Year.ToString();
                    worksheetDG.Cells[9, 2] = clsVarApl.dicVarGen["cNomEmpresa"];
                    worksheetDG.Cells[10, 2] = dtinfo.GetMonthName(dfechaPro.Month);
                    worksheetDG.Cells[10, 4] = pcAnio;
                    ...
                    {
                        fila = rowNumber + 17;
                        worksheetDG.Cells[fila, 3] = dtDatos.Rows[filaDt]["nValSol"];
                        worksheetDG.Cells[fila, 4] = dtDatos.Rows[filaDt]["nValDol"];
                        worksheetDG.Cells[fila, 5] = dtDatos.Rows[filaDt]["ntotal"];
        ...
        private void frmBCRAnexo01_Load(object sender, EventArgs e)
        {
