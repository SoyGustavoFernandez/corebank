...
{
    public partial class frmRegistroOperacionesUnicas : frmBase
    {
        public frmRegistroOperacionesUnicas()
        {
            InitializeComponent();
        }
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtRegOpeUni = new clsRPTCNSplaft().CNRegistroOperacionesUnicas(dFechaInicio, dFechaFinal);

            if (dtRegOpeUni.Rows.Count == 0)
            {
                MessageBox.Show("No existen datos en Registro de operaciones ùnicas", "Registro de operaciones ùnicas", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            else
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    cNomArc = cRuta + "\\01" + dFechaFinal.Year.ToString().Substring(2, 2) +
                    ...
                    pcCadena = "050101" + clsVarApl.dicVarGen["cCodInst"] +
                    ...
                    {
                        pcCadena = Convert.ToInt32(dtRegOpeUni.Rows[i]["nCodRegistro_010"]).ToString().PadLeft(8, '0') +
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cCodSBS_020"]).PadLeft(4,'0') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idCodOperacion_030"]).ToString().PadLeft(8, '0') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idKardex_040"]).ToString().PadLeft(20, '0') +
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cModalidadOpe_050"]).PadLeft(1, '0') +
                                    ...
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idTipRelPerFis_090"]).ToString().PadLeft(1, '0') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idConResPerFis_100"]).ToString().PadLeft(1, '0') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idTipPerFis_110"]).ToString().PadLeft(1, '0') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idTipDocPerFis_120"]).ToString().PadRight(1, ' ') +
                                    Convert.ToString(dtRegOpeUni.Rows[i]["nDocIdePerFis_130"]).ToString().PadLeft(12, ' ') +
                                    ...
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cDesOcuPerFis_200"]).PadRight(104, ' ') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idCargoPerFis_210"]).ToString().PadLeft(2, '0') +
                                    ...
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idTipRelPerOrd_270"]).ToString().PadLeft(1, '0') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idConResPerOrd_280"]).ToString().PadLeft(1, '0') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idTipPerOrd_290"]).ToString().PadLeft(1, '0') +
                                    ...
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cApePatPerOrd_330"]).PadRight(120, ' ') +
                                    ...
                                    dtRegOpeUni.Rows[i]["idCargoPerOrd_390"].ToString().Trim().PadLeft(2, ' ') +
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cDirecPerOrd_400"]).PadRight(150, ' ') +
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cUbiDepPerOrd_410"]).PadLeft(2, ' ') +
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cUbiProPerOrd_420"]).PadLeft(2, ' ') +
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cUbiDisPerOrd_430"]).PadLeft(2, ' ') +
                                    Convert.ToString(dtRegOpeUni.Rows[i]["cNumTelPerOrd_440"]).PadLeft(40, ' ') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idTipRelPerBen_450"]).ToString().PadLeft(1, ' ') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idConResPerBen_460"]).ToString().PadLeft(1, ' ') +
                                    Convert.ToInt32(dtRegOpeUni.Rows[i]["idTipPerBen_470"]).ToString().PadLeft(1, ' ') +
                                    ...
                                    dtRegOpeUni.Rows[i]["idCargoPerBen_570"].ToString().Trim().PadLeft(2, '0') +
                                    ...
                                    Convert.ToString(dtRegOpeUni.Rows[i]["nMontoOperacion_690"]).PadLeft(18, ' ') +
        ...
        private void frmRegistroOperacionesUnicas_Load(object sender, EventArgs e)
        {
