...
{
    public partial class frmLibroRetencion : frmBase
    {
        public frmLibroRetencion()
        {
            InitializeComponent();
        ...
        private void btnLibCaja_Click(object sender, EventArgs e)
        {
            if (Validar())
            {
                ...
                dtslist.Add(new ReportDataSource("dtsRetencion", new clsRPTCNContabilidad().CNLibroRetencion(dFecIni, dFecFin)));

                string reportpath = "RptLibroRetencion.rdlc";
