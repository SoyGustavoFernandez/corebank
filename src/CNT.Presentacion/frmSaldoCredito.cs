...
{
    public partial class frmSaldoCredito : frmBase
    {
        string reportpath = "RptSaldoCreditoResumen.rdlc";
        public frmSaldoCredito()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtSaldo = new clsRPTCNCredito().CNRptSaldosCredito(dFecha);
