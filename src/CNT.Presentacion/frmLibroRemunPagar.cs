...
{
    public partial class frmLibroRemunPagar : frmBase
    {
        public frmLibroRemunPagar()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            dtslist.Add(new ReportDataSource("dtsRemPagar", new clsRPTCNContabilidad().CNLibroRemuneracionPagar(dFecIni, dFecFin)));
            ...
            string reportpath = "RptLibroRemPagar.rdlc";
