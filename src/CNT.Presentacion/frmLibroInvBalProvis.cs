...
{
    public partial class frmLibroInvBalProvis : frmBase
    {
        public frmLibroInvBalProvis()
        {
            InitializeComponent();
        }
        Boolean Validar()
        ...
        private void btnLibCaja_Click(object sender, EventArgs e)
        {
            if (Validar())
            {
                ...
                dtslist.Add(new ReportDataSource("dtsLibInvBalPro", new clsRPTCNContabilidad().CNInvBalProvision(dFecha)));

                string reportpath = "RptLibroProvisiones.rdlc";
