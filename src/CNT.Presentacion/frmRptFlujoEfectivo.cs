...
{
    public partial class frmRptFlujoEfectivo : frmBase
    {
        public frmRptFlujoEfectivo()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("La fecha debe ser menor o igual a la fecha del sistema","Valida flujo de efectivo",MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            } 
            ...
            dtslist.Clear();
            DataTable dtRpt = new clsRPTCNContabilidad().CNRptFlujoEfectivo(dFecha, idAgencia);

            dtslist.Add(new ReportDataSource("dsRptFlujoEfectivo", dtRpt));
            string reportpath = "rptFlujoEfectivoEF.rdlc";
