...
{
    public partial class frmSaldoCastigados : frmBase
    {
        string reportpath = "RptCastigoResumen.rdlc";
        public frmSaldoCastigados()
        {
            InitializeComponent();
        }
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtSaldo = new clsRPTCNCredito().CNRptSaldoCastigados(dFecha, idAgencia);
            if (dtSaldo.Rows.Count == 0)
            {
                MessageBox.Show("No existen datos para el reporte", "Saldos Castigados", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            else
            {
        ...
        private void chcDetalle_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                reportpath = "RptCastigo.rdlc";
            }
            else
            {
                reportpath = "RptCastigoResumen.rdlc";
            }
        }
    }
}
