...
{
    public partial class frmMovCtaCtbEspecifica : frmBase
    {
        public frmMovCtaCtbEspecifica()
        {
            InitializeComponent();
        }
        ...
        private void btnDetalle_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                ...
                dtslist.Add(new ReportDataSource("dtsMovCta", new clsRPTCNContabilidad().CNMovCtaCtbEspecifica(dFecIni, dFecFin, pcCuenta, idMoneda)));
                dtslist.Add(new ReportDataSource("dtsTotales", new clsRPTCNContabilidad().CNMovCtaCtbTotalEspecifica(dFecIni, dFecFin, pcCuenta, idMoneda)));

                string reportpath = "RptMovimientoCuentaCntEspe.rdlc";
        ...
        private void btnResumen_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                ...
                dtslist.Add(new ReportDataSource("dtsResMovCta", new clsRPTCNContabilidad().CNResMovCtaCtbEspecifica(dFecIni, dFecFin, pcCuenta, idMoneda)));
                dtslist.Add(new ReportDataSource("dtsTotales", new clsRPTCNContabilidad().CNMovCtaCtbTotalEspecifica(dFecIni, dFecFin, pcCuenta, idMoneda)));

                string reportpath = "RptResMovCuentaCntEspe.rdlc";
                new frmReporteLocal(dtslist, reportpath, paramlist).ShowDialog();
            }
        }
