...
namespace RSG.Presentacion
{
    public partial class frmIndicadoresProvisiones : frmBase
    {
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = cnRptRsg.IndicadoresProvision(dFechaConsul);
            if (dtData.Rows.Count > 0)
            {
                ...
                string reportPath = "rptIndicadoresProvisiones.rdlc";
