...
namespace RSG.Presentacion
{
    public partial class frmRefinanciamientoOculto : frmBase
    {
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = cnRptRsg.GeneraRefinanciamientoOculto(dFechaConsul);
            if (dtData.Rows.Count > 0)
            {
                ...
                string reportPath = "rptRefinanciadosOcultos.rdlc";
