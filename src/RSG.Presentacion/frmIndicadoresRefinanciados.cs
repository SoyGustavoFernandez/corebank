...
namespace RSG.Presentacion
{
    public partial class frmIndicadoresRefinanciados : frmBase
    {
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = cnRptRsg.IndicadoresRefinanciados(dFechaConsul);
            if (dtData.Rows.Count > 0)
            {
                ...
                string reportPath = "rptIndicadoresRefinanciados.rdlc";
