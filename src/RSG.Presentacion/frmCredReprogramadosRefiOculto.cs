...
namespace RSG.Presentacion
{
    public partial class frmCredReprogramadosRefiOculto : frmBase
    {
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = cnRptRsg.CredReprogramadosRefiOculto(dFechaConsul);
            if (dtData.Rows.Count > 0)
            {
                ...
                string reportPath = "rptCredReprogramadosRefiOculto.rdlc";
