...
namespace RSG.Presentacion
{
    public partial class frmIndicadoresExcepciones : frmBase
    {
        ...
        private void btnImprimir1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtData = cnRptRsg.IndicadoresExcepciones(dFechaConsul);
            if (dtData.Rows.Count > 0)
            {
                ...
                string reportPath = "rptIndicadoresExcepciones.rdlc";
